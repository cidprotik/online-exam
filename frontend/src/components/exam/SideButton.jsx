...
const SideButton = ({ onSidebarClick, selectedSection, sectionName }) => {
  ...
  const { answeredQuestions, unansweredQuestions, markedForReview } =
    useAnswerStore();
        ...
        <div className="card-body">
          ...
          <div id="card_body2" className="showNumberBox">
            <div className="row mx-1 mb-3">
              ...
              <span className="text-white bold col mt-2">Not Answered</span>
            </div>
            <div className="row mx-1 mb-3">
              <div
              ...
              <span className="text-white bold col mt-2">Not Visited</span>
              <div
          ...
          <div className=" d-flex justify-content-center">
            <div className="btn btn-accent w-50" onClick={handleSubmitExam}>Submit Exam</div>
          </div>
        </div>
      </div>
    </div>
